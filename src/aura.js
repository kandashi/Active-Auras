...
class ActiveAuras {
    ...
    static UpdateToken(map, canvasToken, tokenId) {
        ...
        for (const auraEffect of checkEffects) {
            if (AAdebug) console.log(`Checking ${canvasToken.actor.data.name}`, auraEffect);
            ...
            */
            ...
            switch (auraEntityType) {
                ...
                case "template": {
                    ...
                    // if using template, and no radius passed in, use template distance
            ...
            if (distance && !auraEffect.data.flags?.ActiveAuras?.Paused) {
                if (MapObject) {
                    console.warn("adding aura vi MapObject");
                    MapObject.add = true;
                }
                else {
                    console.warn("adding aura vi map.set");
